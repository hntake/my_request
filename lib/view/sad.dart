...
class _SadPageState extends State<SadPage> {
  ...
  void readAloudInAngryPage() {
    ...
    final message1 = widget.preferences.getString('message5') .toString();
    final message2 = widget.preferences.getString('message6') .toString();
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    if ('${preferences.getString('message5').toString()}' != null)
                      Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text('${preferences.getString('message5').toString()}'),
                      ),
                    Image.asset('images/sad.png', width:100),
                    if ('${preferences.getString('message6').toString()}' != null)
                      Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text('${preferences.getString('message6').toString()}'),
                      ),
                  ],
                ),
              ),
