...
class _AngryPageState extends State<AngryPage> {
  ...
  void readAloudInAngryPage() {
    ...
    final message1 = widget.preferences.getString('message1') .toString();
    final message2 = widget.preferences.getString('message2') .toString();
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    if ('${widget.preferences.getString('message1').toString()}' !=
                        null)
                      Padding(
                    ...
                    Image.asset('images/angry.png', width: 100),
                    if ('${widget.preferences.getString('message2').toString()}' !=
                        null)
                      Padding(
                        padding: EdgeInsets.all(8.0),
