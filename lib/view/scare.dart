...
class _ScarePageState extends State<ScarePage> {
  ...
  void readAloudInAngryPage() {
    ...
    final message1 = widget.preferences.getString('message7') .toString();
    final message2 = widget.preferences.getString('message9') .toString();
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    if ('${preferences.getString('message7').toString()}' != null)
                      Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text('${preferences.getString('message7').toString()}'),
                      ),
                    Image.asset('images/scare.png', width: 100),
                    if ('${preferences.getString('message8').toString()}' != null)
                      Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text('${preferences.getString('message8').toString()}'),
                      ),
                  ],
                ),
              ),
