...
class _LoginState extends State<Login> {
  ...
  void loginUser() async {
    ...
    if (result.statusCode == 200) {
      ...
      final message1Value = response['feel']['message1'] ?? defaultMessage;
      final message2Value = response['feel']['message2'] ?? defaultMessage;
      final message3Value = response['feel']['message3'] ?? defaultMessage;
      final message4Value = response['feel']['message4'] ?? defaultMessage;
      final message5Value = response['feel']['message5'] ?? defaultMessage;
      final message6Value = response['feel']['message6'] ?? defaultMessage;
      final message7Value = response['feel']['message7'] ?? defaultMessage;
      final message8Value = response['feel']['message8'] ?? defaultMessage;
